...
import { Eye, Search, FileText, Sparkles, Trash2, Calendar } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!loading && !error && posts.length === 0 && (
          <div className="bg-white/80 dark:bg-background/10 backdrop-blur-lg border border-gray-200 dark:border-0 rounded-2xl p-12 text-center shadow-xl">
            <FileText className="mx-auto text-gray-400 dark:text-paragraph mb-4" size={64} />
            <h3 className="text-xl font-bold text-gray-800 dark:text-background mb-2">No posts yet</h3>
            <p className="text-gray-600 dark:text-paragraph">
              Start creating blog posts to share your insights
            </p>
          </div>
        )}
        ...
        {!loading && !error && filtered.length === 0 && posts.length > 0 && (
          <div className="bg-white/80 dark:bg-background/10 backdrop-blur-lg border border-gray-200 dark:border-0 rounded-2xl p-8 text-center shadow-xl">
            ...
            <h3 className="text-xl font-bold text-gray-800 dark:text-background mb-2">No posts found</h3>
            <p className="text-gray-600 dark:text-paragraph">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-gray-800 dark:text-background mb-2 line-clamp-2">
                      {post.title}
                    </h3>
                    ...
                    {post.content && (
                      <p className="text-sm text-gray-600 dark:text-paragraph line-clamp-3 mb-4">
                        {post.content}
                      </p>
                    )}
                  </div>
