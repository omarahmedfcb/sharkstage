...
import AdminProjectsTable from "@/app/components/admin/AdminProjectsTable";
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-4">
            <div className="p-4 bg-gradient-to-br from-[#0f3460] to-[#16213e] dark:from-primary/20 dark:to-secondary/20 rounded-2xl shadow-xl border border-[#0f3460]/50 dark:border-primary/30">
              <FolderKanban className="text-purple-400 dark:text-secondary-dark" size={40} />
            </div>
            <div>
              ...
              <p className="text-gray-300 dark:text-paragraph text-lg">
                Manage all platform projects, view details, and delete projects
              </p>
            </div>
          </div>
        </motion.div>
